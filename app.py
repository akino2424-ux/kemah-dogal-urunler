...
# Jinja2 template ayarları
app.jinja_env.auto_reload = True
app.jinja_env.cache = {}

# Flask static dosya servisi için özel ayarlar
...
def css_files(filename):
    """CSS dosyaları için özel route"""
    return static_files(f'css/{filename}')

# JS dosyaları için özel route
@app.route('/js/<path:filename>')
def js_files(filename):
    """JavaScript dosyaları için özel route"""
    return static_files(f'js/{filename}')

# Images dosyaları için özel route
@app.route('/images/<path:filename>')
def image_files(filename):
    """Image dosyaları için özel route"""
    return static_files(f'images/{filename}')

# Uploads dosyaları için özel route
@app.route('/uploads/<path:filename>')
def upload_files(filename):
    """Upload dosyaları için özel route"""
    return static_files(f'uploads/{filename}')
...
def send_password_reset_email(user_email, reset_token, user_name):
    try:
        ...
        # HTML e-posta gövdesi - Template'den yükle
